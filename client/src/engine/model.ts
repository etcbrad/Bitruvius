...
export const INITIAL_JOINTS: Record<string, Joint> = {
  navel: { id: 'navel', label: 'Navel', parent: null, baseOffset: { x: 0, y: 0 }, currentOffset: { x: 0, y: 0 }, targetOffset: { x: 0, y: 0 }, previewOffset: { x: 0, y: 0 } },
  ...
  collar: { id: 'collar', label: 'Collar', parent: 'sternum', baseOffset: { x: 0, y: -2 }, currentOffset: { x: 0, y: -2 }, targetOffset: { x: 0, y: -2 }, previewOffset: { x: 0, y: -2 } },
  neck_base: { id: 'neck_base', label: 'Neck Base', parent: 'collar', baseOffset: { x: 0, y: -1 }, currentOffset: { x: 0, y: -1 }, targetOffset: { x: 0, y: -1 }, previewOffset: { x: 0, y: -1 } },
  head: { id: 'head', label: 'Head', parent: 'neck_base', baseOffset: { x: 0, y: -2 }, currentOffset: { x: 0, y: -2 }, targetOffset: { x: 0, y: -2 }, previewOffset: { x: 0, y: -2 }, isEndEffector: true },
  ...
  l_shoulder: { id: 'l_shoulder', label: 'L Shoulder', parent: 'collar', baseOffset: { x: -3, y: 0.5 }, currentOffset: { x: -3, y: 0.5 }, targetOffset: { x: -3, y: 0.5 }, previewOffset: { x: -3, y: 0.5 }, mirrorId: 'r_shoulder' },
  ...
  r_shoulder: { id: 'r_shoulder', label: 'R Shoulder', parent: 'collar', baseOffset: { x: 3, y: 0.5 }, currentOffset: { x: 3, y: 0.5 }, targetOffset: { x: 3, y: 0.5 }, previewOffset: { x: 3, y: 0.5 }, mirrorId: 'l_shoulder' },
  ...
  l_hip: { id: 'l_hip', label: 'L Hip', parent: 'navel', baseOffset: { x: -2, y: 1 }, currentOffset: { x: -2, y: 1 }, targetOffset: { x: -2, y: 1 }, previewOffset: { x: -2, y: 1 }, mirrorId: 'r_hip' },
  ...
  r_hip: { id: 'r_hip', label: 'R Hip', parent: 'navel', baseOffset: { x: 2, y: 1 }, currentOffset: { x: 2, y: 1 }, targetOffset: { x: 2, y: 1 }, previewOffset: { x: 2, y: 1 }, mirrorId: 'l_hip' },
