...
export const generateProceduralPose = (args: {
  ...
  if (mode === 'idle') {
    ...
    if (out.joints.neck_upper) out.joints.neck_upper = rotateOffset(out.joints.neck_upper, s * 0.75 * strength);
    ...
    if (out.joints.r_upper_arm) out.joints.r_upper_arm = rotateOffset(out.joints.r_upper_arm, -s * 1.5 * strength);
    return out;
  }
