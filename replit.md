...
## Architecture
- **Frontend**: React 18 with TypeScript, Tailwind CSS, shadcn/ui components, Wouter routing
...
## Dependencies
All npm dependencies are installed in `node_modules/`. Key packages include `tsx` (TypeScript runner), `vite`, `express`, `react`, `@radix-ui/*` components, `tailwindcss`.
